...
## Layout
- `src/App.tsx` — top-level app; composes the practice UI. Colocated tests: `App.firstRun.test.tsx`, `App.install.test.tsx`, `App.integration.test.tsx`, `App.mic.test.tsx`, `App.practiceLog.test.tsx`, `App.recap.test.tsx`, `App.routines.test.tsx`, `App.skin.test.tsx`, `App.stage.test.tsx`.
